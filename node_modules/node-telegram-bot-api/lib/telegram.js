...
var TelegramBot = function (_EventEmitter) {
  ...
  _createClass(TelegramBot, [{
    ...
    key: 'sendMessage',
    value: function sendMessage(chatId, text, parseMode, markup) {
    ...
    key: 'editMessageText',
    value: function editMessageText(chatId, messageId, text, parseMode, replyMarkup) {
      var form = {};
      form.chat_id = chatId;
